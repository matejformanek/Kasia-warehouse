...
- New models that persist user-submitted data (e.g. `Feedback` per 0046, `ContactInquiry` per 0050) — the durability/retention story is a decision, not an implementation detail
